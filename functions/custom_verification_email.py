...
<body>
    <h1 style="color: #ff9a00;">Welcome, <span>{name}</span></h1>
    <p>We're excited to have you get started. First, you need to confirm your <span style="color: #ff9a00; text-decoration: none;">{email}</span> To do that just click on below button.</p>
    {link}
</body>
</html>"""
...
def lambda_handler(event, context):
    ...
    if event['triggerSource'] == 'CustomMessage_SignUp':
        ...
        verification_link = event['request']['codeParameter']
